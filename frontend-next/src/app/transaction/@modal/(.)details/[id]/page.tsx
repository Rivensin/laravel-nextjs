...
export default function DetailTransactionPage(props: any){
          ...
          <div className="w-80 max-h-[550px] bg-gray-50 px-4 pt-8 shadow-lg overflow-y-auto scrollbar-thin scrollbar-thumb-gray-400">
            ...
            <div className="flex flex-col gap-3 pb-6 pt-2 text-xs">
                  ...
                  <div className='flex justify-between'>
                    ...
                    <div className='font-bold underline text-lg bg-gray-200'>{transaction.total.toLocaleString('id-ID')}</div>
                  </div>
